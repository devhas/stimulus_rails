...
class EmployeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create employee' do
    assert_difference('Employee.count') do
      post employees_url,
           params: {
             employee: { email: Faker::Internet.email, first_name: @employee.first_name, last_name: @employee.last_name,
                         nickname: @employee.nickname, phone_number: @employee.phone_number }, format: :turbo_stream
           }
    end
  ...
  test 'should not save employee with too long first name' do
    employee = Employee.new(
      first_name: 'John Saved the employee with ivalid phone number format Saved the employee with ivalid phone number format', last_name: 'Cena', email: 'john.cena@gmail.com', phone_number: '1234567'
    )
  ...
  test 'should not save employee with invalid phone number format' do
    employee = Employee.new(first_name: 'John', last_name: 'Cena', email: 'john.cena@gmail.com',
  ...
  test 'should update employee' do
    patch employee_url(@employee),
          params: {
            employee: { email: @employee.email, first_name: @employee.first_name, last_name: @employee.last_name,
                        nickname: @employee.nickname, phone_number: @employee.phone_number }, format: :turbo_stream
          }
    assert_response :success
  end
